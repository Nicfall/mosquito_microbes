...
#ggsave(file="fig1_timeline_aug24.pdf",height=3.25,width=5.25)
#ggsave(file="fig1_timeline_aug24.png",height=3.25,width=5.25)
```

## Average time to emergence (Fig. S1)
...
#ggsave("figs1_emerge_rate_aug24.pdf",width=5,height=3.5)
#ggsave("figs1_emerge_rate_aug24.png",width=5,height=3.5)
```
...
#ggsave("fig1_prop.pdf",width=4,height=2.5)
#ggsave("fig1_prop.png",width=4,height=2.5)
```
